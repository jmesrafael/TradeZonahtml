...
let currentUser=null,trades=[],settings=null,userIsPro=false;
...
function getBrandingData(){const username=currentUser?.user_metadata?.username||currentUser?.email?.split('@')[0]||'';const referralCode=currentUser?.user_metadata?.referral_code||currentUser?.user_metadata?.referralCode||'';return{username,referralCode};}

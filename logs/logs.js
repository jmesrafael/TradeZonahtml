...
function onPairInput(el,id){const t=trades.find(x=>x.id===id);if(t)t.pair=el.value.toUpperCase();_pending.add(id);scheduleSave(id);const v=el.value.trim();if(v.length>0)showSug(el,id);else hideSugImmediate(id);}
